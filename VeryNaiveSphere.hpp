...
public:
    ...
    std::vector<glm::vec3> getInsidePoints(pcl::PointCloud<pcl::PointXYZRGB>::Ptr &cloud, pcl::octree::OctreePointCloudSearch<pcl::PointXYZRGB> &octree)
    {
        ...
        {
            insidePoints.emplace_back(cloud->points[idx].x, cloud->points[idx].y, cloud->points[idx].z);
        }
